...
<div id="ddtRoot" style="position:absolute;inset:0;background:radial-gradient(60% 48% at 14% 0%,rgba(245,158,11,.20),transparent 64%),radial-gradient(52% 44% at 90% 4%,rgba(255,209,102,.13),transparent 62%),radial-gradient(130% 95% at 50% -8%,#4B2D8F,#2b1d5e 32%,#160f38 60%,#03040c 100%);overflow:hidden;font-family:Inter,sans-serif;color:#fff;user-select:none;-webkit-user-select:none">
  ...
  <div id="ddtTopBar" style="position:absolute;top:0;left:0;right:0;z-index:20;display:flex;align-items:center;padding:12px 14px;gap:10px;background:linear-gradient(180deg,rgba(3,4,12,.95) 70%,transparent)">
    ...
    <button onclick="ddtShowHelp()" title="How to play" aria-label="How to play" style="padding:7px 11px;border:1px solid rgba(75,45,143,.6);border-radius:9px;background:rgba(75,45,143,.2);color:#A78BFA;cursor:pointer;font-size:.8rem">❓</button>
