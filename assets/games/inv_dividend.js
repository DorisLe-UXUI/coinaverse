  ...
  window.SCREENS.game_inv_dividend = function () {
    ...
    return `<div id="divd-root" style="position:absolute;inset:0;background:${BG_DEEP};overflow:hidden;font-family:Inter,sans-serif;color:#fff;user-select:none">
      ...
      <div id="divd-topbar" style="position:absolute;top:0;left:0;right:0;z-index:20;display:flex;align-items:center;gap:6px;padding:8px 8px;background:linear-gradient(180deg,rgba(3,4,12,.95),transparent)">
        ...
        <button id="divd-help-btn" title="How to play" aria-label="How to play" style="padding:6px 7px;border:1px solid ${ACCENT_DIM};border-radius:8px;background:rgba(0,200,83,.1);color:${ACCENT};cursor:pointer;flex-shrink:0;font-size:.78rem">❓</button>
